...
<?php
// TOTAL GERAL PIX
$sql4 = mysqli_query( $db_con, "SELECT SUM(v_pedido) AS soma5 FROM pedidos WHERE 1=1 AND (data_hora > '$data_inicial_sql' AND data_hora < '$data_final_sql') AND rel_estabelecimentos_id = '$eid' AND forma_pagamento = '6' AND status = '2'" );
$define_data4 = mysqli_fetch_array( $sql4 );
...
<p class="style4">
    <code><b>Total PIX:</b></code><br />
    <code>R$: <?php echo number_format($define_data4['soma5'], 2, ',', '.');?></code>
</p>

<?php
// TOTAL GERAL DINHEIRO
$sql4 = mysqli_query( $db_con, "SELECT SUM(v_pedido) AS soma6 FROM pedidos WHERE 1=1 AND (data_hora > '$data_inicial_sql' AND data_hora < '$data_final_sql') AND rel_estabelecimentos_id = '$eid' AND forma_pagamento = '1' AND status = '2'" );
$define_data4 = mysqli_fetch_array( $sql4 );
...
<p class="style4">
    <code><b>Total DINHEIRO:</b></code><br />
    <code>R$: <?php echo number_format($define_data4['soma6'], 2, ',', '.');?></code>
</p>

<?php
// TOTAL GERAL CARTÂO DE DEBITO
$sql4 = mysqli_query( $db_con, "SELECT SUM(v_pedido) AS soma7 FROM pedidos WHERE 1=1 AND (data_hora > '$data_inicial_sql' AND data_hora < '$data_final_sql') AND rel_estabelecimentos_id = '$eid' AND forma_pagamento = '2' AND status = '2'" );
$define_data4 = mysqli_fetch_array( $sql4 );
...
<p class="style4">
    <code><b>Total DÉBITO:</b></code><br />
    <code>R$: <?php echo number_format($define_data4['soma7'], 2, ',', '.');?></code>
</p>

<?php
// TOTAL GERAL CARTÂO DE CREDITO
$sql4 = mysqli_query( $db_con, "SELECT SUM(v_pedido) AS soma8 FROM pedidos WHERE 1=1 AND (data_hora > '$data_inicial_sql' AND data_hora < '$data_final_sql') AND rel_estabelecimentos_id = '$eid' AND forma_pagamento = '3' AND status = '2'" );
$define_data4 = mysqli_fetch_array( $sql4 );
...
<p class="style4">
    <code><b>Total CRÉDITO:</b></code><br />
    <code>R$: <?php echo number_format($define_data4['soma8'], 2, ',', '.');?></code>
</p>

<?php
// TOTAL GERAL TICKET ALIMENTACAO
$sql4 = mysqli_query( $db_con, "SELECT SUM(v_pedido) AS soma9 FROM pedidos WHERE 1=1 AND (data_hora > '$data_inicial_sql' AND data_hora < '$data_final_sql') AND rel_estabelecimentos_id = '$eid' AND forma_pagamento = '4' AND status = '2'" );
$define_data4 = mysqli_fetch_array( $sql4 );
...
<p class="style4">
    <code><b>Total TICKET ALIMENTAÇÃO:</b></code><br />
    <code>R$: <?php echo number_format($define_data4['soma9'], 2, ',', '.');?></code>
</p>

<?php
// TOTAL GERAL OUTORS
$sql4 = mysqli_query( $db_con, "SELECT SUM(v_pedido) AS soma10 FROM pedidos WHERE 1=1 AND (data_hora > '$data_inicial_sql' AND data_hora < '$data_final_sql') AND rel_estabelecimentos_id = '$eid' AND forma_pagamento = '5' AND status = '2'" );
$define_data4 = mysqli_fetch_array( $sql4 );
...
<p class="style4">
    <code><b>Total OUTROS:</b></code><br />
    <code>R$: <?php echo number_format($define_data4['soma10'], 2, ',', '.');?></code>
</p>

<?php
// TOTAL GERAL MERCADOPAGO
$sql4 = mysqli_query( $db_con, "SELECT SUM(v_pedido) AS soma11 FROM pedidos WHERE 1=1 AND (data_hora > '$data_inicial_sql' AND data_hora < '$data_final_sql') AND rel_estabelecimentos_id = '$eid' AND forma_pagamento = '7' AND status = '2'" );
$define_data4 = mysqli_fetch_array( $sql4 );
...
<p class="style4">
    <code><b>Total MERCADOPAGO:</b></code><br />
    <code>R$: <?php echo number_format($define_data4['soma11'], 2, ',', '.');?></code>
</p>					


<?php
// TOTAL GERAL GETNET
$sql4 = mysqli_query( $db_con, "SELECT SUM(v_pedido) AS soma12 FROM pedidos WHERE 1=1 AND (data_hora > '$data_inicial_sql' AND data_hora < '$data_final_sql') AND rel_estabelecimentos_id = '$eid' AND forma_pagamento = '9' AND status = '2'" );
$define_data4 = mysqli_fetch_array( $sql4 );
...
<p class="style4">
    <code><b>Total GETNET:</b></code><br />
    <code>R$: <?php echo number_format($define_data4['soma12'], 2, ',', '.');?></code>
</p>
</div>
