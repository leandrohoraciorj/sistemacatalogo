  ...
  if( $formdata ) {
    ...
    // Setar campos
      ...
      // Dados gerais
        ...
        $accesstoken = mysqli_real_escape_string( $db_con, $_POST['accesstoken'] );
      ...
      // Pagamento
        ...
        // PIX
        $pagamento_pix_mp = mysqli_real_escape_string( $db_con, $_POST['pagamento_pix_mp'] );
        // PIX
        $pagamento_pix = mysqli_real_escape_string( $db_con, $_POST['pagamento_pix'] );
		
		$pagamento_pix_chave = mysqli_real_escape_string( $db_con, $_POST['pagamento_pix_chave'] );
				...
				<div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <label>Aceita cartão de débito?</label>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        if( $dataestabelecimento['pagamento_cartao_debito_bandeiras'] ) {
                          ...
                          $field_pagamento_debito_bandeiras = "Mastercard, Visa, Elo, Hipercard";

                        }

                        ?>

                        <label>Quais bandeiras aceitas:</label>

                        <input type="text" name="pagamento_cartao_debito_bandeiras" placeholder="Mastercard, Visa, Elo, Hipercard" value="<?php echo htmlclean( $field_pagamento_debito_bandeiras ); ?>">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <label>Aceita PIX via Mercado Pago?</label>
                        <div class="form-field-radio">
                          <input type="radio" name="pagamento_pix_mp" element-show=".elemento-pagamento-pix_mp" value="1" <?php if( $dataestabelecimento['pagamento_pix_mp'] == 1 OR !$dataestabelecimento['pagamento_pix_mp'] ){ echo 'CHECKED'; }; ?>> Sim
                        </div>
                        <div class="form-field-radio">
                          <input type="radio" name="pagamento_pix_mp" element-hide=".elemento-pagamento-pix_mp" value="2" <?php if( $dataestabelecimento['pagamento_pix_mp'] == 2 ){ echo 'CHECKED'; }; ?>> Não
                        </div>
                        <div class="clear"></div>
				...
				<div class="row elemento-pagamento-pix <?php if( $dataestabelecimento['pagamento_pix'] == "2" ){ echo 'elemento-oculto'; }; ?>">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <input type="text" name="pagamento_pix_chave" placeholder="SUA CHAVE AQUI" value="<?php echo htmlclean( $dataestabelecimento['chave_pix'] ); ?>">
                    </div>
                    ...
                    <div class="row elemento-mercadopago <?php if( $dataestabelecimento['pagamento_mercadopago'] == "2" ){ echo 'elemento-oculto'; }; ?>">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <label>Aceita retirada balcão?</label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <label>Aceita entrega na mesa?</label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <input type="text" name="contato_youtube" placeholder="Digite o link do google maps" value="<?php echo htmlclean( $dataestabelecimento['contato_youtube'] ); ?>">
