...
<?php
  ...
  if( $formdata ) {
    ...
    if( !$checkerrors ) {
      ...
      if( $pid = new_produto( $eid,$categoria,$destaque,$estoque,$mostrar_estoque,$ref,$nome,$descricao,$valor,$oferta,$valor_promocional,$variacao,$status,$visible,$integrado,$pesofrete,$alturafrete,$largurafrete,$comprimentofrete,$diametrofrete ) ) {
			...
			<div class="col-md-4">
              <div class="form-field-default">
               <label>Quantidade Estoque:</label>
                    <input type="text" name="estoque" value="0">
              </div>
            </div>
         ...
         <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-field-default">
                ...
                <div class="form-field-radio">
                      <input type="radio" name="mostrar_estoque" value="1" <?php if( $_POST['mostrar_estoque'] == 1 OR !$_POST['mostrar_estoque'] ){ echo 'CHECKED'; }; ?>> Sim

                </div>
                <div class="form-field-radio">
                      <input type="radio" name="mostrar_estoque" value="2" <?php if( $_POST['mostrar_estoque'] == 2 ){ echo 'CHECKED'; }; ?>> Não
