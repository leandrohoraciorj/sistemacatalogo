...
$estoque = mysqli_real_escape_string( $db_con, $_GET['estoque'] );
								    ...
								    <div class="row">
                                                                                <div class="col-md-4">
                                                                                        <div class="form-field-default">
                                                                                                <label>Estoque:</label>
	                                                                                     <input type="text" name="nome" placeholder="Nome" value="<?php echo htmlclean( $estoque ); ?>"/>
                                                                                        </div>
                                                                                </div>
						...
						<tbody>
							...
							<tr>
								<td>
                                    ...
                                    <div class="fake-table-data"><?php echo htmlclean( $data['estoque'] ); ?></div>
