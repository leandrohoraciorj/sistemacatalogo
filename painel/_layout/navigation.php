	...
	<ul class="nav navbar-nav">
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu">
                ...
                <li><a href="<?php panel_url(); ?>/produtos/importar"><i class="lni lni-radio-button"></i> Importar</a></li>
			</ul>
		</li>
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu">
				...
				<li><a href="<?php panel_url(); ?>/clientes"><i class="lni lni-cog"></i> Clientes</a></li>
		...
		<li class="active"><a href="https://api.whatsapp.com/send?text=Aderi a *BrandX* para ter uma loja virtual para minha empresa integrado com o WhatsApp, cadastre-se vc também e teste sem compromisso, venha conhecer essa ferramenta maravilhosa. Eu estou gostando muito, *clique no link:* https://deliverysolutions.com.br/comece/cadastrar/?afiliado=<?php echo user_info('email'); ?>">Indique 1 amigo</a></li>
		<!--
