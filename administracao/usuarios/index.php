...
$level = mysqli_real_escape_string( $db_con, $_GET['level'] );
											...
											<div class="form-field-default">
												...
												<div class="fake-select">
													...
													<select name="level">
			                                            ...
			                                            <option value="<?php echo $numeric_data['level'][$x]['value']; ?>" <?php if( $level == $numeric_data['level'][$x]['value'] ) { echo 'SELECTED'; }; ?>><?php echo $numeric_data['level'][$x]['name']; ?></option>
			                                            <?php } ?>
													</select>
													<div class="clear"></div>
												</div>
