						...
						<?php } ?>
								...
								<?php if($app['exibicao'] ==2){ ?>
											...
											<?php } ?>
												...
												<div class="row">
													...
													<div class="col-md-9 col-sm-7 col-xs-7 npr">
														...
														<span class="valor_anterior" style="text-decoration: line-through;">R$: <?php echo dinheiro( $data_produtos['valor'], "BR" ); ?></span>
									...
									<div class="col-md-3 col-infinite">
										...
										<div class="produtoatual">
										    
										    
										    <?php if($data_produtos['estoque'] == 1 ) { ?>

											<a href="<?php echo $app['url']; ?>/produto/<?php echo $data_produtos['id']; ?>">
											...
											<?php } ?>
												...
												<div class="capa" style="background: url(<?php echo thumber( $data_produtos['destaque'], 450 ); ?>) no-repeat center center;">
												    ...
												    <div class="detalhes auto_height_item">
														<div class="linha">
													<span class="nome"><?php echo htmlclean( $data_produtos['nome'] ); ?></span>
												</div>
												<div class="linha">
													<span class="informacoes">												<?php if( $valor_final > 0 ) { ?>
												<?php if( $data_produtos['oferta'] == "1" ) { ?>
												...
												<span class="valor">R$ <?php echo dinheiro( $valor_final, "BR" ); ?></span></span>
												</div>
												</div>
