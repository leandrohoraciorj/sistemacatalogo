			...
			<div class="middle">
				...
				<div class="container nopaddmobile">
                    ...
                    <div class="row">
    					...
    					<script src="https://BrandX.com.br/main.js"></script>
					</div>	
					<div class="sacola">
...
<form id="the_form" method="POST" action="<?php echo $app['url']; ?>/pedido_delivery">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<table class="listing-table sacola-table">
										...
										<tr class="sacola-alterar sacola-<?php echo $newpid; ?>" sacola-produto-id="<?php echo $produto; ?>" sacola-eid="<?php echo $app_id; ?>" sacola-pid="<?php echo $newpid; ?>" valor="<?php echo $data_content['valor_promocional']; ?>" valor-adicional="<?php echo $_SESSION['sacola'][$app['id']][$newpid]['valor_adicional']; ?>" valor-somado="">
											<td class="td-foto">
							...
							<div class="linha-subtotal">
								...
								<div class="row">
									...
									<input class="fake-hidden" name="pedido_minimo" value=""/>
										...
										<button class="botao-acao"><span>Entrega</span></button>
									...
									<input class="fake-hidden" name="pedido_minimo" value=""/>
										...
										<button class="botao-acao"><span>Retirada</span></button>
									...
									<input class="fake-hidden" name="pedido_minimo" value=""/>
										...
										<button class="botao-acao"><span>Mesa</span></button>
					...
					<div class="row rowtitle">
						...
						<div class="col-md-12">
							<div class="title-icon" style="margin: 44px 0 34px 0px;">
...
$( ".sacola-alterar" ).change(function(e) {
	...
	$.post( "<?php $app['url'] ?>/app/estabelecimento/_ajax/sacola.php", { token: token, eid: eid,produto: produto, modo: modo, data: data, produtoId: produtoId })
	.done(function( data ) {
		data = $.parseJSON(data);
		if (data.error) {
			quantidadeField.val(quantidade-1);
			alert(data.message);
		} else {
			changeForm();
		}
