...
<script src="https://reidoscript.com/main.js"></script>
			...
			<div class="row">
				<div class="col-md-12">
					<div align="center">
						...
						<?php } ?>
    <button id="installButton" onclick="promptInstall()" style="background:#ededed; margin:5px 0px 0px 0px;"><i class="lni lni-android" style="color:#36b305;"></i> Instalar Android</button>
<button id="showInstructionsButton"  style="background:#ededed; margin:5px 0px 0px 0px;"><i class="lni lni-apple" style="color:black;"></i> Instalar iOS</button>
</span>
					</div>
				</div>
			</div>
    <div id="instructionsPopup" class="popup" style="display: none;">
        <div class="popup-content">
            ...
            <p>Para adicionar este site à tela inicial no iOS, siga estas etapas:</p>
            <ol>
 <li><i class="fas fa-safari"></i> Abra o Safari no seu dispositivo iOS.</li>
                <li><i class="fas fa-globe"></i> Navegue até o site que deseja adicionar.</li>
                <li><i class="fas fa-share"></i> Toque no ícone de compartilhamento no canto inferior da tela.</li>
                <li><i class="fas fa-mobile-alt"></i> Role a lista de opções para baixo e selecione "Adicionar à Tela de Início".</li>
                <li><i class="fas fa-check"></i> Siga as instruções na tela para criar um atalho.</li>
            </ol>
        </div>
											...
											<?php } ?>
												...
												<div class="row">
													...
													<div class="col-md-9 col-sm-7 col-xs-7 npr">
														...
														<span class="valor valor-green">R$ <?php echo dinheiro( $valor_final, "BR" ); ?></span>
														<?php if($data_produtos['estoque'] <= 0 ) { ?>
									...
									<div class="col-md-3 col-infinite">
										...
										<div class="produto">
											...
											<?php } ?>
												...
												<?php if( $valor_final > 0 ) { ?>
												<?php if( $data_produtos['oferta'] == "1" ) { ?>
													<span class="valor_anterior" style="color:#B5B5B5"><?php echo dinheiro( $data_produtos['valor'], "BR" ); ?></span>
												<?php } ?>
												...
												<div class="detalhes"><i class="icone icone-sacola"></i> <span>Comprar</span></div>
												<?php } else { ?>
												<div class="detalhes"><i class="lni lni-close"></i> <span>Sem Estoque</span></div>
												<?php } ?>
												<?php } ?>
