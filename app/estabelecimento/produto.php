...
include($virtualpath.'/_layout/top2.php');
						...
						<div class="col-md-7">
							...
							<div class="padd-container-mobile">
								...
								<div class="produto-detalhes">
											...
											<div class="row">
												<div class="col-md-12">
													...
													<div class="valor_anterior">
														<span><?php if( $data_content['oferta'] == "1" ) { ?>De: <strike><?php echo dinheiro( $data_content['valor'], "BR" ); ?></strike><?php } ?> <?php if( has_variacao( $data_content['id'] ) ) { echo ""; } else { echo ""; }; ?></span>
													</div>
									...
									<?php if ($data_content['mostrar_estoque'] == 1 and $data_content['estoque']) { ?>
										<div class="row">
											...
											<div class="col-md-9">
												...
												<div class="row">
													<div class="col-md-12">
														<div class="ref">
															<span><?php echo htmlclean($data_content['estoque']); ?> unidade(s)</span>
														</div>
													</div>
												</div>
							...
							<div produto-id="<?php echo $data_content['id']; ?>" variacao-id="<?php echo $x; ?>" variacao-produto-id="<?php echo $y; ?>" class="opcao<?php if (htmljson($variacao[$x]['item'][$y]['estoque']) == "0" and $data_content['mostrar_estoque'] >= "1") {
																																																						echo "indisponivel";
																																																					} else {
																																																					} ?> <?php if (variacao_opcao_ativa($data_content['id'], $x, $y)) {
																																																																																										echo 'active';
																																																																																									}; ?>" variacao-item="<?php echo $y; ?>" valor-adicional="<?php echo htmljson($variacao[$x]['item'][$y]['valor']); ?>"">
